...
def write_blog_post(topic, output_file="blog_post_bc.md"):
    """
...
topic = "Create a blog post about the top 5 products of B Circle so far. Please include specific product names and sources"
print(topic)
